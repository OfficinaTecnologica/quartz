Per capire come usare un comando posso usare `man NOMECOMANDO`

al posto di NOMECOMANDO devi mettere il nome del comando. Sì, esatto, ho dovuto specificarlo

**Muoversi nel file system** (So che voi scrollatori seriali non avete mai visto una directory o un file, ma oggi diventerete degli uomini, o delle donne, a vostra preferenza)
